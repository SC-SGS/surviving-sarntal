...
#ifndef SURVIVING_SARNTAL_TERRAINRENDERER_H
#define SURVIVING_SARNTAL_TERRAINRENDERER_H
...
class TerrainRenderer {
  public:
    explicit TerrainRenderer(Camera2D &camera, GameConstants &gameConstants, ResourceManager &resourceManager);
...
#endif // SURVIVING_SARNTAL_TERRAINRENDERER_H
