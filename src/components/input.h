...
const std::unordered_map<Event, ButtonEvent> KEYBOARD_KEY_MAP{
    ...
    {DUCK, {DEVICE_KEYBOARD, KEY_LEFT_SHIFT, TRIGGER_DOWN}},
    {ITEM_PICK, {DEVICE_KEYBOARD, KEY_Q, TRIGGER_PRESSED}},
    {ITEM_USE, {DEVICE_KEYBOARD, KEY_E, TRIGGER_PRESSED}},
    {ITEM_DROP, {DEVICE_KEYBOARD, KEY_F, TRIGGER_PRESSED}},
    {SPECIAL_ABILITY, {DEVICE_KEYBOARD, KEY_R, TRIGGER_PRESSED}},
    {FULLSCREEN, {DEVICE_KEYBOARD, KEY_F11, TRIGGER_PRESSED}},
    {TOGGLE_DEBUG, {DEVICE_KEYBOARD, KEY_P, TRIGGER_PRESSED}},
