...
TwoDimensionalHermiteSpline::TwoDimensionalHermiteSpline(floatType startT, floatType endT, Vector start, Vector end,
    ...
    this->xSpline = new HermiteSpline(startT, endT, start.x, end.x, this->startDer.x, this->endDer.x);
    this->ySpline = new HermiteSpline(startT, endT, start.y, end.y, this->startDer.y, this->endDer.y);
}
...
StaticPolyline *TwoDimensionalHermiteSpline::getPolyrepresentation(floatType resolution) const {
